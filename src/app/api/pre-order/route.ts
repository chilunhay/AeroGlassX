      ...
      try {
        await fetch(webhookUrl, {
          ...
          body: JSON.stringify({
            ...
            avatar_url: "https://images.unsplash.com/photo-1593508512255-86ab42a8e620?q=80&w=150&auto=format&fit=crop",
            embeds: [
              {
                ...
                fields: [
                  ...
                  { name: "📊 Điểm cuộn trang đạt được", value: scrollDepthReached || "0%", inline: true },
                  { name: "⏰ Thời gian đăng ký", value: new Date().toLocaleString("vi-VN", { timeZone: "Asia/Ho_Chi_Minh" }), inline: false }
                ],
